...
public class Modificar extends JPanel {
	    	...
	    	public void actionPerformed(ActionEvent e) {
	    		...
	    		try{
		    		...
		    		if(!tipo.equals("")){
		    			...
		    			JOptionPane.showMessageDialog(null, "No se ha introducido nada, ya que el campo estaba vacio", null, JOptionPane.WARNING_MESSAGE);
	    ...
	    btnsubtipo_editar.addActionListener(new ActionListener() {
	    	public void actionPerformed(ActionEvent e) {
	    		...
	    		try{
	    			...
	    			String subtipo=JOptionPane.showInputDialog("Introduce el nuevo subtipo de componentes del tipo: " + combo_tipo.getSelectedItem() + ".");
	    			
	    			if(!subtipo.equals("")){
	    				
	    				Consultas.añadirSubtipo(subtipo, combo_tipo.getSelectedItem().toString());
	    				renovarComboSubTipo();
	...
	public boolean comprobacionesVacio(){
		...
		if(txt_nombre.getText().equals("") || txt_desc.getText().equals("") || combo_tipo.getSelectedItem() == null || combo_subtipo.getSelectedItem() == null){
